...
df = pd.read_csv(
    "C:/Users/Teju Sraav/Desktop/Sravan/WhitehatJr Python/Python Classes/Single sample z-tests/School2.csv")
...
fig1.add_trace(go.Scatter(x=[ReadingScore_first_std_deviation_start, ReadingScore_first_std_deviation_start], y=[
               0, 0.7], mode="lines", name="Start STD 1"))
...
fig1.add_trace(go.Scatter(x=[ReadingScore_second_std_deviation_start, ReadingScore_second_std_deviation_start], y=[
               0, 0.7], mode="lines", name="Start STD 2"))
...
fig1.add_trace(go.Scatter(x=[ReadingScore_third_std_deviation_start, ReadingScore_third_std_deviation_start], y=[
               0, 0.7], mode="lines", name="Start STD 3"))
...
df2 = pd.read_csv(
    "C:/Users/Teju Sraav/Desktop/Sravan/WhitehatJr Python/Python Classes/Single sample z-tests/School_1_Sample.csv")
...
df3 = pd.read_csv(
    "C:/Users/Teju Sraav/Desktop/Sravan/WhitehatJr Python/Python Classes/Single sample z-tests/School_2_Sample.csv")
...
df4 = pd.read_csv(
    "C:/Users/Teju Sraav/Desktop/Sravan/WhitehatJr Python/Python Classes/Single sample z-tests/School_3_Sample.csv")
...
zScore1 = (mean_of_sample1-ReadingScore_Mean) / ReadingScore_SD
zScore2 = (mean_of_sample3-ReadingScore_Mean) / ReadingScore_SD
zScore3 = (mean_of_sample4-ReadingScore_Mean) / ReadingScore_SD
print("zScore for the sampling data 1 : ", zScore1)
print("zScore for the sampling data 2 : ", zScore2)
print("zScore for the sampling data 3 : ", zScore3)
